...
- Project: `~/.gemini/continuous-learning/projects/<project-hash>/observations.jsonl`
- Global fallback: `~/.gemini/continuous-learning/observations.jsonl`
...
- Project: `~/.gemini/continuous-learning/projects/<project-hash>/instincts/personal/`
- Global: `~/.gemini/continuous-learning/instincts/personal/` (for universal patterns)
